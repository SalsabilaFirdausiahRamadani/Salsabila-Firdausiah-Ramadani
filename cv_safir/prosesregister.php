...
if (isset($_POST['submit'])) {
    ...
    $cek_user = mysqli_query($conn, "SELECT * FROM cvdatabase WHERE id = '$id'");
    ...
    $insert_query = "INSERT INTO cvdatabase (id, nama, alamat, telepon, email, web, pendidikan, pengalaman, keterampilan, foto_path) VALUES ('$id', '$nama', '$alamat', '$telepon', '$email', '$web', '$pendidikan', '$pengalaman', '$keterampilan', '$foto_path')";
